...
- 💶 **Other expenses** — insurance, tax, registration, roadworthiness inspection (§57a "Pickerl"/TÜV), parking, tolls, vignette, fines, accessories; feeds total cost of ownership
...
- 🔎 **Search** — find vehicles, service records, intervals, refuellings, tyres, documents and other expenses across your fleet; a hit is a clickable row that jumps straight to that entry on the vehicle page
...
- 🔑 **Passkeys** — optional passwordless sign-in with fingerprint, face or device PIN (WebAuthn); the password keeps working as a fallback
